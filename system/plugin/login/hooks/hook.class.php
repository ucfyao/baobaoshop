...
class plugin_login_hook extends plugin{
    ...
    public function set_reg_extra()
    {
        ...
        $html = form::input('checkbox', 'switchs[]', $config['switchs'], '可用第三方登录方式：', '可以选择开启关闭不同的第三方登录方式以供用户登录。', array('items' => array('alipay'=>'支付宝登录', 'qq'=>'QQ登录', 'sina'=>'新浪微博登录', 'wechat'=>'微信登录', 'wechat_wap'=>'微信手机登录')));
        echo $html;
	}
