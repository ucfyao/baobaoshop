		...
		<div class="picture-space clearfix">
			<div class="left-wrap text-white">
				...
				<?php foreach($module AS $k => $v):?>
					<li><a <?php if($_GET['folder']==$k){echo 'class="current"';}?> href="<?php echo url('ajax_picture_space',array('folder'=>$k))?>"><?php echo $v;?></a></li>
				<?php endforeach;?>
				</ul>
			</div>
			<div class="right-wrap">
				<div class="space-bar padding-big-left padding-big-right border-bottom">
					<a href="<?php echo url('ajax_picture_space',array('folder'=>$_GET['folder']))?>" <?php if(!$_GET['type']){echo 'class="current"';}?>>全部图片</a>
					<a href="<?php echo url('ajax_picture_space',array('folder'=>$_GET['folder'],'type'=>'used'))?>" <?php if($_GET['type']=='used'){echo 'class="current"';}?>>已使用图片</a>
					<a href="<?php echo url('ajax_picture_space',array('folder'=>$_GET['folder'],'type'=>'unused'))?>" <?php if($_GET['type']=='unused'){echo 'class="current"';}?>>未使用图片</a>
						...
						<div class="form-group margin-left">
							...
							<div class="box">
								<div class="form-select-edit">
									...
									<input type="hidden" name="a" value="ajax_picture_space" />
									<div class="form-buttonedit-popup">
