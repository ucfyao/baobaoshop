...
class admin_control extends init_control {
	...
	public function index() {
		...
		$this->load->librarys('View')->assign('attachments',$attachments)->assign('spaces',$spaces)->display('attachment_index');
	}
	...
	public function manage() {
		...
		$this->load->librarys('View')->assign('lists',$lists)->assign('pages',$pages)->display('attachment_manage');
	}
